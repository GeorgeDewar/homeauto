...
sw2 = Device.create(name: 'Switch 2', definition: 'WattsClever', properties: {
    on: '62E65D', off: '62E655'
}.to_json)

sw3 = Device.create(name: 'Switch 3', definition: 'WattsClever', properties: {
    on: '62E65F', off: '62E657'
}.to_json)
